...
{
    public class ChromeDriverDecorator : ChromeDriver, IAtWebDriver
    {
        ...
        private static int DefaultPollingInterval =>
            AtConfiguration.GetDefaultConfiguration("DefaultPollingInterval", 500);
        ...
        private static ChromeDriverOptions ChromeOptions
        {
            get
            {
                ...
                chromeDriverOptions.AddUserProfilePreference("plugins.always_open_pdf_externally", false); 
        ...
        public ChromeDriverDecorator()
            : this(ChromeDriverDirectory, ChromeOptions)
        {
        }

        public ChromeDriverDecorator(DriverOptions driverOptions)
           : this(ChromeDriverDirectory, (ChromeDriverOptions)driverOptions)
        {
        }

        private ChromeDriverDecorator(string chromeDriverDirectory, ChromeOptions options)
            : base(chromeDriverDirectory, options, TimeSpan.FromSeconds(DefaultHttpRequestTimeout))
        {
        ...
        public void WaitForElementClickable(IAtWebElement element, int secs, string message = "Element is not visible")
        {
            _navigationHandler.WaitForElementClickable(this, element, secs, message);
        }

        public void WaitForElementClickable(IAtWebElement element)
        {
            _navigationHandler.WaitForElementClickable(this, element, DefaultWaitForElement);
        }

        public void WaitForElementClickable(IAtWebElement element, string message = "Element is not clickable")
        {
            _navigationHandler.WaitForElementClickable(this, element, DefaultWaitForElement, message);
        }

        public void WaitUntilNotVisible(AtWebElement element, string message = "Element is visible")
        {
            _navigationHandler.WaitUntilNotVisible(this, element, DefaultWaitForElement, message);
        }

        public void WaitUntilNotVisible(AtWebElement element, int secs, string message = "Element is visible")
        {
