...
namespace Dnata.TravelRepublic.MobileWeb.UI.Tests.Features.Meta.Hotel
{
    ...
    [NUnit.Framework.DescriptionAttribute("MetaKayakHotel")]
    [NUnit.Framework.CategoryAttribute("MetaRegression")]
    public partial class MetaKayakHotelFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Meta/Hotel", "MetaKayakHotel", "\tIn order to verify meta deeplink URLs\r\n\tAs a tester\r\n\tI want to generate deepLin" +
...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("verify KayakUK Hotel MetaChannel")]
        [NUnit.Framework.CategoryAttribute("UKOnly")]
        [NUnit.Framework.TestCaseAttribute("Kayak UK", "1", "2,1,0", "30", "6", "117436,117347,117305", null)]
        public virtual void VerifyKayakUKHotelMetaChannel(string metaChannel, string noOfRooms, string occupancy, string startDaysFromCurrentDate, string duration, string estabIds, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("verify KayakUK Hotel MetaChannel", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 12
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("verify KayakIE Hotel MetaChannel")]
        [NUnit.Framework.TestCaseAttribute("Kayak IE", "1", "2,1,1", "15", "6", "2540494,117468,117305", null)]
        public virtual void VerifyKayakIEHotelMetaChannel(string metaChannel, string noOfRooms, string occupancy, string startDaysFromCurrentDate, string duration, string estabIds, string[] exampleTags)
        {
            ...
            argumentsOfScenario.Add("duration", duration);
            argumentsOfScenario.Add("estabIds", estabIds);
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("verify KayakIE Hotel MetaChannel", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 27
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
