...
namespace Dnata.TravelRepublic.MobileWeb.UI.Tests.Features.Meta.Hotel
{
    ...
    [NUnit.Framework.DescriptionAttribute("MetaTrivagoHotel")]
    [NUnit.Framework.CategoryAttribute("MetaRegression")]
    public partial class MetaTrivagoHotelFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Meta/Hotel", "MetaTrivagoHotel", "\tIn order to verify meta deeplink URLs\r\n\tAs a tester\r\n\tI want to generate deepLin" +
...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("verify TrivagoUK Hotel MetaChannel")]
        [NUnit.Framework.CategoryAttribute("UKOnly")]
        [NUnit.Framework.TestCaseAttribute("Trivago UK", "1", "2,0,0", "30", "5", "117468,117305,126042", null)]
        public virtual void VerifyTrivagoUKHotelMetaChannel(string metaChannel, string noOfRooms, string occupancy, string startDaysFromCurrentDate, string duration, string estabIds, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("verify TrivagoUK Hotel MetaChannel", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 12
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("verify TrivagoIE Hotel MetaChannel")]
        [NUnit.Framework.TestCaseAttribute("Trivago IE", "1", "2,1,0", "30", "5", "117468,230981,126042", null)]
        public virtual void VerifyTrivagoIEHotelMetaChannel(string metaChannel, string noOfRooms, string occupancy, string startDaysFromCurrentDate, string duration, string estabIds, string[] exampleTags)
        {
            ...
            argumentsOfScenario.Add("duration", duration);
            argumentsOfScenario.Add("estabIds", estabIds);
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("verify TrivagoIE Hotel MetaChannel", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 28
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
