...
export class SearchUnit extends Page {
    ...
    private async inputRoomSelection(roomCount) {
        return await $("//*[@name='room-toggle' and @value='" + roomCount + "']");
    }

    private async areaRoomSelection(roomCount) {
        return await $("//*[@name='room-toggle' and @value='" + roomCount + "']/..//div");
    }
    ...
    async verifyActiveElementText(activeElelementText) {
        ...
        expect(await $(activeElement)).toHaveTextContaining(activeElelementText);
    }
